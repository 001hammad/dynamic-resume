...
var generateResume = function () {
    var skillsHTML = resumeForm.skill.map(function (skill) { return "<ul><li><p> ".concat(skill, "</p></li></ul>"); }).join('');
    var ResumeHtmlSec = "\n         <div class='main-output'>\n             <div class='left-sec'>\n                 <img src='".concat(resumeForm.picture, "' alt='profile-pic' width='150' height='150' class=\"photo\">\n                 <div class='left-inner-content'>\n                     <p><u><h4 class=\"Professional-Summary\">Professional Summary</h4></u><br>").concat(resumeForm.summary, "</p>\n                     <p><u><h4 class=\"Career-Objective\">Career Objective</h4></u><br>").concat(resumeForm.objective, "</p>\n                 </div>\n             </div>\n \n             <div class='right-sec'>\n                 <div class='right-inner-content'>\n                     <h1 class=\"title\">").concat(resumeForm.title, "</h1>\n                     <h3 class='ts-headings'>Personal Information</h3>\n                     <p><b>Full Name:</b> ").concat(resumeForm.name, "</p>\n                     <p><b>Email Id:</b> ").concat(resumeForm.email, "</p>\n                     <p><b>Address:</b> ").concat(resumeForm.address, "</p>\n                     <p><b>Contact Number:</b> ").concat(resumeForm.phone, "</p><hr>\n                     <h3 class='ts-headings'>Education</h3>\n                     <p><b>Institution:</b> ").concat(resumeForm.institution, "</p>\n                     <p><b>Degree:</b> ").concat(resumeForm.degree, "</p>\n                     <p><b>Passing Year:</b> ").concat(resumeForm.year, "</p><hr>\n \n                     <h3 class='ts-headings'>Skills</h3>\n                     ").concat(skillsHTML, "\n \n                     <h3 class='ts-headings'><b>Work Experience</b></h3>\n                     <p><b>Job Title:</b> ").concat(resumeForm.jobtitle, "</p>\n                     <p><b>Company:</b> ").concat(resumeForm.company, "</p>\n                     <p><b>Year:</b> ").concat(resumeForm.year, "</p>\n                     <h3 class=\"ts-headings\"><b>Description</b></h3>\n                     <p> ").concat(resumeForm.description, "</p>\n                 </div>\n             </div>\n         </div>\n     ");
